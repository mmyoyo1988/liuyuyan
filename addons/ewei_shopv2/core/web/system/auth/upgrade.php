...
class Upgrade_EweiShopV2Page extends SystemPage
{
	...
	public function check()
	{
		...
		set_time_limit(0);
		$auth = get_auth();
		if(!$auth['code'])show_json(0, '&#x5F00;&#x5427;&#x6E90;&#x7801;&#x793E;&#x533A;&#x63D0;&#x9192;&#x60A8;&#xFF0C;&#x8BF7;&#x70B9;&#x6B64;&#x67E5;&#x770B;&#x65B0;&#x7248;&#xFF01;<a href="http://www.k8ym.com">&#x7ACB;&#x5373;&#x67E5;&#x8BE2;</a>');
//		$release = ((defined('EWEI_SHOPV2_RELEASE') ? EWEI_SHOPV2_RELEASE : '20181101141657'));
		$resp = ihttp_request('http://www.k8ym.com/', array('ip' => $auth['ip'], 'modname' => $auth['modname'], 'code' => $auth['code'], 'domain' => trim(preg_replace('/http(s)?:\\/\\//', '', trim($_W['siteroot'], '/'))), 'version' => $version, 'release' => $release, 'manual' => 1, 'plugins' => array_keys($plugins)));
		$templatefiles = '';
	...
	public function process()
	{
		...
		if ($action == 'file') {
			...
			if (!empty($path)) {
				$resp = ihttp_request('http://www.k8ym.com/mod.php?a=mod&b=download', array('ip' => $auth['ip'], 'modname' => $auth['modname'], 'code' => $auth['code'], 'domain' => trim(preg_replace('/http(s)?:\\/\\//', '', rtrim($_W['siteroot'], '/'))), 'path' => $path));
	...
	protected function updateComplete($version, $release)
	{
		...
		$sql ="UPDATE  `ims_modules` SET  `version` =  '$version',`author` =  '开吧源码社区',`url` =  'http://www.k8ym.com/' WHERE  `name` ='ewei_shopv2'";
		pdo_query($sql);
