...
class Agent_EweiShopV2Page extends PluginWebPage 
{
	public function main() 
	{
		...
		foreach( $list as &$row ) 
		{
			...
			$row["system_total"] = $info["system_total"];
			$row["system_pay"] = $info["system_pay"];
	...
	public function user() 
	{
		...
		else 
		{
			...
			else 
			{
				...
				{
					if( $level == 3 && 2 < $this->set["level"] && 0 < $level3 ) 
					{
