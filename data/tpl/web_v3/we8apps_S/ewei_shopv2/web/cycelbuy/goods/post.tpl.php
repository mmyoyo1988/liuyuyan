...
<div class="page-header">
    ...
    <?php  if(!empty($item['id'])) { ?>编辑<?php  } else { ?>添加<?php  } ?>商品 <small><?php  if(!empty($item['id'])) { ?>修改【<span class="text-info"><?php  echo $item['title'];?></span>】<?php  } ?></small>
    </span>
</div>
...
<div class="page-sub-toolbar">
	<span class=''>
		<?php if(cv('goods.add')) { ?>
        <a class="btn btn-primary btn-sm" href="<?php  echo webUrl('cycelbuy/goods/add')?>" >添加商品</a>
		<?php  } ?>
		<?php if(cv('goods.add')) { ?>
        <!--<a class="btn btn-primary btn-sm" href="<?php  echo webUrl('cycelbuy/goods/create')?>" >快速添加商品</a>-->
		<?php  } ?>
    </span>
</div>
<form <?php if( ce('goods' ,$item) ) { ?>action="" method="post"<?php  } ?> class="form-horizontal form-validate" enctype="multipart/form-data">
    ...
    <div class="tabs-container tab-goods">
        <div class="tabs-left">
            <ul class="nav nav-tabs" id="myTab">
                ...
                <li <?php  if($_GPC['tab']=='sell') { ?>class="active"<?php  } ?>><a href="#tab_sell" id="a_sell">分销</a></li>
                <?php  } ?>
            ...
            <div class="tab-content  ">
                <div class="tab-pane   <?php  if(empty($_GPC['tab']) || $_GPC['tab']=='basic') { ?>active<?php  } ?>" id="tab_basic"><div class="panel-body"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('cycelbuy/goods/tab/basic', TEMPLATE_INCLUDEPATH)) : (include template('cycelbuy/goods/tab/basic', TEMPLATE_INCLUDEPATH));?></div></div>
                <div class="tab-pane  <?php  if($_GPC['tab']=='option') { ?>active<?php  } ?>" id="tab_option"> <div class="panel-body"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('cycelbuy/goods/tab/option', TEMPLATE_INCLUDEPATH)) : (include template('cycelbuy/goods/tab/option', TEMPLATE_INCLUDEPATH));?></div></div>
                <div class="tab-pane <?php  if($_GPC['tab']=='param') { ?>active<?php  } ?>" id="tab_param"> <div class="panel-body"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('cycelbuy/goods/tab/param', TEMPLATE_INCLUDEPATH)) : (include template('cycelbuy/goods/tab/param', TEMPLATE_INCLUDEPATH));?></div></div>
                <div class="tab-pane <?php  if($_GPC['tab']=='des') { ?>active<?php  } ?>" id="tab_des"> <div class="panel-body" style='padding:0;'><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('cycelbuy/goods/tab/des', TEMPLATE_INCLUDEPATH)) : (include template('cycelbuy/goods/tab/des', TEMPLATE_INCLUDEPATH));?></div></div>
                <div class="tab-pane <?php  if($_GPC['tab']=='buy') { ?>active<?php  } ?>" id="tab_buy"> <div class="panel-body"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('cycelbuy/goods/tab/buy', TEMPLATE_INCLUDEPATH)) : (include template('cycelbuy/goods/tab/buy', TEMPLATE_INCLUDEPATH));?></div></div>
                <div class="tab-pane <?php  if($_GPC['tab']=='sale') { ?>active<?php  } ?>" id="tab_sale" > <div class="panel-body" ><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('cycelbuy/goods/tab/sale', TEMPLATE_INCLUDEPATH)) : (include template('cycelbuy/goods/tab/sale', TEMPLATE_INCLUDEPATH));?></div></div>
                <div class="tab-pane <?php  if($_GPC['tab']=='discount') { ?>active<?php  } ?>" id="tab_discount"> <div class="panel-body"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('cycelbuy/goods/tab/discount', TEMPLATE_INCLUDEPATH)) : (include template('cycelbuy/goods/tab/discount', TEMPLATE_INCLUDEPATH));?></div></div>
                <div class="tab-pane <?php  if($_GPC['tab']=='share') { ?>active<?php  } ?>" id="tab_share"> <div class="panel-body"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('cycelbuy/goods/tab/share', TEMPLATE_INCLUDEPATH)) : (include template('cycelbuy/goods/tab/share', TEMPLATE_INCLUDEPATH));?></div></div>
                <div class="tab-pane  <?php  if($_GPC['tab']=='notice') { ?>active<?php  } ?>" id="tab_notice"> <div class="panel-body"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('cycelbuy/goods/tab/notice', TEMPLATE_INCLUDEPATH)) : (include template('cycelbuy/goods/tab/notice', TEMPLATE_INCLUDEPATH));?></div></div>

                <?php  if(p('commission') && !empty($com_set['level'])) { ?>
                    <div class="tab-pane <?php  if($_GPC['tab']=='sell') { ?>active<?php  } ?>" id="tab_sell">
                        <div class="panel-body"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('commission/goods', TEMPLATE_INCLUDEPATH)) : (include template('commission/goods', TEMPLATE_INCLUDEPATH));?></div>
                    </div>
                <?php  } ?>
                ...
                <?php  if($merchid == 0) { ?>
                <div class="tab-pane <?php  if($_GPC['tab']=='detaildiy') { ?>active<?php  } ?>" id="tab_detaildiy"> <div class="panel-body"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('cycelbuy/goods/tab/detaildiy', TEMPLATE_INCLUDEPATH)) : (include template('cycelbuy/goods/tab/detaildiy', TEMPLATE_INCLUDEPATH));?></div></div>
                <?php  } ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 subtitle">
			...
			<a class="btn btn-default" href="<?php  echo webUrl('cycelbuy/goods',array('goodsfrom'=>$_GPC['goodsfrom'], 'page'=>$_GPC['page']))?>">返回列表</a>
        </div>
    </div>
    <?php  } ?>
</form>
...
<script type="text/javascript">
	...
	$('form').submit(function(){
		...
		var spec_item_title = 1;
			...
			$(".spec_item").each(function (i) {
				var _this = this;
				if($(_this).find(".spec_item_iscycelbuy").val()==0 && $(_this).find(".spec_item_title").length == 0){
                    spec_item_title = 0;
                }
			});
	...
	function optionArray()
	{
        ...
        var option_cycelbuy_periodic = new Array();
        $('.option_cycelbuy_periodic').each(function (index,item) {
            option_cycelbuy_periodic.push($(item).val());
        });
		...
		var options = {
			...
			option_id : option_id,
            option_cycelbuy_periodic: option_cycelbuy_periodic,
...
//                    cycelbuy_periodic=specs[m].items[kid].period+","+specs[m].items[kid].time_unit+","+specs[m].items[kid].number;
				...
				if (j % rowspan == 0) {
					h[m][j] = {
						title: title,
//                        cycelbuy_periodic:cycelbuy_periodic,
