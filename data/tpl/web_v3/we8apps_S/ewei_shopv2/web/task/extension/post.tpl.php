        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <div class="input-group">
                    <?php  echo tpl_form_field_eweishop_daterange('data[time1]',array('start'=>$data['starttime'],'end'=>$data['endtime']), true)?>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                ...
                <div id="couponlist">
                    ...
                    <span class="couponlist" id="coupon<?php  echo $cv['id'];?>"><?php  echo $cv['name'];?>
                        <span class="badge badge-warning">x1</span>
                        <a class="" onclick="$(this).parent().remove()" style="float: right;">X</a><input type="hidden" name="data[reward_data][coupon][<?php  echo $cv['id'];?>][id]" value="<?php  echo $cv['id'];?>">
                        <input type="hidden" name="data[reward_data][coupon][<?php  echo $cv['id'];?>][num]" value="<?php  echo $cv['num'];?>">
                        <input type="hidden" name="data[reward_data][coupon][<?php  echo $cv['id'];?>][name]" value="<?php  echo $cv['name'];?>">
                    </span>
                    <?php  } } ?>
                </div>
            </div>
            ...
            <div class="col-sm-7">
                ...
                <div id="goodslist">
                    ...
                    <span class="goodslist" id="goods<?php  echo $gk;?>">
                        <span class="badge badge-success">¥<?php  echo $gv['price'];?></span>
                        <span class="badge badge-warning">x<?php  echo $gv['num'];?></span><?php  echo $gv['name'];?>
                        <a class="btn btn-danger" onclick="$(this).parent().remove()" style="float: right;">X</a>
                        <input type="hidden" name="data[reward_data][goods][<?php  echo $gk;?>][option]" value="<?php  echo $gv['option'];?>">
                        <input type="hidden" name="data[reward_data][goods][<?php  echo $gk;?>][num]" value="1">
                        <input type="hidden" name="data[reward_data][goods][<?php  echo $gk;?>][price]" value="2">
                        <input type="hidden" name="data[reward_data][goods][<?php  echo $gk;?>][id]" value="<?php  echo $gv['id'];?>"><input type="hidden" name="data[reward_data][goods][<?php  echo $gk;?>][name]" value="<?php  echo $gv['name'];?>"></span>
                    <?php  } } ?>
                </div>
            </div>
        </div>
