...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <div class="input-group">
            ...
            <span class="input-group-addon" style="padding: 0px;"><img src="<?php  if(!empty($item['titleicon'])) { ?><?php  echo $item['titleicon'];?><?php  } else { ?>../addons/ewei_shopv2/plugin/task/static/images/taskicon.png<?php  } ?>" id="showimg" width="30px" height="28px"></span>
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        ...
        <div class="input-group">
            ...
            <span class="input-group-addon" style="padding: 0px;"><img src="<?php  if(!empty($item['poster_banner'])) { ?><?php  echo $item['poster_banner'];?><?php  } else { ?>../addons/ewei_shopv2/plugin/task/static/images/detail-head.jpg<?php  } ?>" id="showbanner" width="30px" height="28px"></span>
...
<div class="form-group">
    <label class="col-lg control-label must">任务推广人数</label>
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('task.edit')) { ?>
...
<div class="form-group">
    <label class="col-lg control-label">关注后自动接任务</label>
    <div class="col-sm-9 col-xs-12">
        <?php if(cv('task.edit')) { ?>
