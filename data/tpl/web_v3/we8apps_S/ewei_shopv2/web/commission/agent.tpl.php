...
<?php  if(count($list)>0) { ?>
        ...
        <table class="table table-hover table-responsive">
           ...
           <tr >
                ...
                <td><span class="text-danger"><?php  echo $row['commission_total'];?></span><br/><span class="text-warning"><?php  echo $row['commission_pay'];?></span></td>				                <td><span class="text-danger"><?php  echo $row['system_total'];?></span><br/><span class="text-warning"><?php  echo $row['system_pay'];?></span></td>				                <td><span class="text-danger"><?php  echo $row['tmcount'];?></span></td>				
                <td >
