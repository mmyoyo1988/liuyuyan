                    ...
                    <tr <?php  if($row['id']=='default') { ?>style='background:#f2f2f2'<?php  } ?>>
                        ...
                        <?php  if($set['level']>=1) { ?><td><?php  echo number_format((float)$row['commission1'],2)?>%</td><?php  } ?>
                         <?php  if($set['level']>=2) { ?><td><?php  echo number_format((float)$row['commission2'],2)?>%</td><?php  } ?>
						  ...
						  <td><?php  echo number_format((float)$row['tmcommission'],2)?>元</td>
						  <td><?php  echo number_format((float)$row['pjcommission'],2)?>元</td>
						...
						<?php  if($leveltype==11) { ?><?php  if($row['tmdowncount']>0) { ?>一级分销商人数满 <?php  echo $row['downcount'];?> 个<br>团队分销商人数满 <?php  echo $row['tmdowncount'];?> 个 <?php  } else { ?>不自动升级<?php  } ?><?php  } ?>						
					<?php  } else { ?>
					默认等级
					<?php  } ?>
                          </td>
