      ...
      <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<div class="form-group">
                    <label class="col-sm-2 control-label">团队级差佣金</label>
                          <div class="col-sm-9 col-xs-12">
                      <?php if( ce('member.level' ,$level) ) { ?>
                          <div class='input-group'>
                        <input type="text" name="tmcommission" class="form-control" value="<?php  echo $level['tmcommission'];?>" />
                          <div class='input-group-addon'>元</div>
                        </div>
						<?php  } else { ?>
						<div class='form-control-static'><?php  echo $level['tmcommission'];?>%</div>
						<?php  } ?> 
                    </div>
                </div>
				
				<div class="form-group">
                    <label class="col-sm-2 control-label">团队平级佣金</label>
                          <div class="col-sm-9 col-xs-12">
                      <?php if( ce('member.level' ,$level) ) { ?>
                          <div class='input-group'>
                        <input type="text" name="pjcommission" class="form-control" value="<?php  echo $level['pjcommission'];?>" />
                          <div class='input-group-addon'>元</div>
                        </div>
						<?php  } else { ?>
						<div class='form-control-static'><?php  echo $level['pjcommission'];?>%</div>
						<?php  } ?> 
                    </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <div class='input-group'>
							...
							<?php  } ?>
							<?php  if($leveltype==11) { ?>
									<span class='input-group-addon'>一级分销商人数满</span>
									<input type="text" name="downcount" class="form-control" value="<?php  echo $level['downcount'];?>" />
									<span class='input-group-addon'>个</span>
									
									<span class='input-group-addon'>团队分销商人数满</span>
									<input type="text" name="tmdowncount" class="form-control" value="<?php  echo $level['tmdowncount'];?>" />
									<span class='input-group-addon'>个</span>
							<?php  } ?>
