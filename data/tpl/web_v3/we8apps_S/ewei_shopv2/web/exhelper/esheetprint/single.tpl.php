		...
		<div class="panel-body">
			<div class="page-toolbar" style="margin-bottom: 0px;">
				...
				<span class="input-group-select">
					...
					<input type="text" class="form-control"  name="search_keyword" value="<?php  echo $_GPC['keyword'];?>" placeholder="请输入关键词"/>
...
<script language="javascript">
    ...
    function search(){
        ...
        $.ajax({
            url: "<?php  echo webUrl('exhelper/esheetprint/single/getdata')?>",
            data: data,
            type: "post",
            success:function(html){
                ...
                $('.result-item').click(function(){
                    ...
                    $.ajax({
                          url: "<?php  echo webUrl('exhelper/esheetprint/single/getorder')?>",
