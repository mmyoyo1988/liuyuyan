	...
	<div class="search-box we7-margin-bottom">
		<div class="search-form">
			<select name="" id="" class="we7-margin-right">
				...
				<?php  if(permission_check_account_user('see_message_order')) { ?>
				<option data-url="<?php  echo url('message/notice', array('type' => MESSAGE_ORDER_TYPE))?>" <?php  if($type == MESSAGE_ORDER_TYPE) { ?> selected <?php  } ?>>订单消息</option>
				<?php  } ?>
