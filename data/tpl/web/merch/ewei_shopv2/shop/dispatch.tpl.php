        ...
        <form action="" method="post">
            <div class="page-table-header">
                ...
                <div class="btn-group">
                    ...
                    <?php  } ?>
                    <?php if(mcv('shop.dispatch.delete')) { ?>
                    ...
                    <?php  if(is_array($list)) { foreach($list as $item) { ?>
                        <tr>
                            ...
                            <td style="text-align:left;">
                                <?php if(mcv('shop.dispatch.view|shop.dispatch.edit')) { ?>
                                    <a href="<?php  echo webUrl('shop/dispatch/edit', array('id' => $item['id']))?>" class="btn btn-op btn-operation" >
                                        <span data-toggle="tooltip" data-placement="top" data-original-title="<?php if(mcv('shop.dispatch.edit')) { ?>修改<?php  } else { ?>查看<?php  } ?>">
