...
<div class="page-content">
    <div class='alert alert-danger'>1.尽量在服务器空闲时间来操作，会占用大量内存与带宽，在获取过程中，请不要进行任何操作!</br>
        2.由于京东商品规格为不同链接的商品，所以京东助手无法获取京东商品内的其他规格!
        </br>3.暂不支持全球购等海外商品链接
    </div>
...
<script type="text/javascript">
    ...
    function fetch_next() {
        ...
        $.post("<?php  echo merchUrl('taobao/jingdong/fetch')?>",
                postdata,
                function (data) {
                    ...
                    if (len >= total) {
                        ...
                        if (confirm('商品已经获取成功, 是否跳转到商品管理?')) {
                            location.href = "<?php  echo merchUrl('goods' ,array('goodsfrom'=>stock))?>";
                        }
                        else {
                            location.reload();
                        }
