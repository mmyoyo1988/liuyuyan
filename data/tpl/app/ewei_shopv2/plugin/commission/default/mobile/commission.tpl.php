...
<div class="fui-page fui-page-current page-commission-index ">
	...
	<div class="headinfo">
		...
		<div class="userblock">
			<div class="line total new">
				<div class="num"><?php  echo number_format($member['commission_pay']+$member['system_pay'],2)?></div>
				<div class="title"><?php  echo $this->set['texts']['commission_pay']?>(<?php  echo $this->set['texts']['yuan']?>)</div>
			</div>
			<div class="line usable new">

				<div class="text">
					<div class="num"><?php  echo number_format( $member['commission_ok']+$member['system_ok'],2)?></div>
	...
	<div class="fui-block-group new col-2" style='overflow: hidden;'>
            ...
            </a>						<a class="fui-block-child new  external" href="<?php  echo mobileUrl('commission/systembouns')?>">                <div class="icon " style="color: #ff4357;"><i class="icon icon-qian"></i></div>                <div class="text new">					<div class="title">系统分红</div>                    <div class=""><span><?php  echo number_format($member['system_total'],2)?></span> <?php  echo $this->set['texts']['yuan']?></div>				</div>            </a>
            ...
            </a>			<!-- <a class="fui-block-child new  external" ">
				<div class="icon " style="color: #ff4357;"><i class="icon icon-qian"></i></div>				<div class="text new">					<div class="title">团队总业绩</div>					<div class=""><span><?php  echo number_format($member['tmshopprice'],0)?></span>元</div>				</div>			</a> -->
		<?php  if($hasdividend) { ?>
