...
<div class="fui-page fui-page-current page-commission-index ">
	...
	<div class="headinfo">
		...
		<div class='fui-list-inner'>
		    <div class='subtitle'><?php  echo number_format($member['system_total'],2)?></div>
	...
	<div class='fui-cell-group'>
		...
		<div class='fui-cell-remark noremark' ><span class="text-orange"><?php  echo number_format($member['system_ok'],2)?> <?php  echo $this->set['texts']['yuan']?></span></div>
	    </div>
	</div>
	...
	<div class='fui-cell-group'>
		...
		<div class='fui-cell-info' ></div>
		<div class='fui-cell-remark noremark' ><?php  echo number_format($member['system_apply'],2)?> <?php  echo $this->set['texts']['yuan']?></div>
	    </div>
	    <div class='fui-cell'>
		...
		<div class='fui-cell-info' ></div>
		<div class='fui-cell-remark noremark' ><?php  echo number_format($member['system_check'],2)?> <?php  echo $this->set['texts']['yuan']?></div>
	    </div>
		...
		<div class='fui-cell'>
			...
			<div class='fui-cell-info' ></div>
			<div class='fui-cell-remark noremark' ><?php  echo number_format($member['system_fail'],2)?> <?php  echo $this->set['texts']['yuan']?></div>
		</div>
		...
		<div class='fui-cell-info' ></div>
		<div class='fui-cell-remark noremark' ><?php  echo number_format($member['system_pay'],2)?> <?php  echo $this->set['texts']['yuan']?></div>
	    </div>
	...
	<div class='fui-cell-group'>
		...
		<div class='fui-cell-info' ></div>
		<div class='fui-cell-remark noremark' ><?php  echo number_format($member['system_wait'],2)?> <?php  echo $this->set['texts']['yuan']?></div>
	    </div>
	    <!-- <div class='fui-cell'>
		...
		<div class='fui-cell-info' ></div>
		<div class='fui-cell-remark noremark' ><?php  echo number_format($member['system_lock'],2)?> <?php  echo $this->set['texts']['yuan']?></div>
	    </div> -->
	</div>
	...
	<div class="fui-navbar">
		<a <?php  if($cansettle ) { ?>href="<?php  echo mobileUrl('commission/systemapply')?>"<?php  } ?> class="nav-item btn btn-warning block<?php  if(!$cansettle ) { ?> disabled<?php  } ?>">我要提现</a>
	</div>
    </div>
